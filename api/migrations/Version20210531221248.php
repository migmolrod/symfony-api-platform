 ...
 */
final class Version20210531221248 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creates `user_group` and `user_group_user` tables and updates `user` table with its relationships';
    }
